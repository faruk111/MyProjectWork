...
<html lang="bn">
	...
	<ul>
		...
		<li><a href="#">Donors by Group</a>
			<ul>
				<li><a href="../search/A_negative.php">A negative(-)</a></li>
		<li><a href="../search/A_positive.php">A positive(+)</a></li>
		<li><a href="../search/AB_negative.php">AB negative(-)</a></li>
		<li><a href="../search/AB_positive.php">AB positive(+)</a></li>
		<li><a href="../search/B_negative.php">B negative(-)</a></li>
		<li><a href="../search/B_positive.php">B positive(+)</a></li>
		<li><a href="../search/O_negative.php">O negative(-)</a></li>
		<li><a href="../search/O_positive.php">O positive(+)</a></li>
		</ul>
	...
	<li><a href="http://localhost/badhan/contruct_us/contract.html">Contact Us</a></li>
		...
		$query="select ID,month,name,father_name,mother_name,village,po,phone,gender,weight,blood_group,Date,checkbox from information_table where blood_group='AB+' and month>='3'";
