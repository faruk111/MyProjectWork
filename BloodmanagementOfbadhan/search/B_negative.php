...
<html lang="bn">
	...
	<li><a href="http://localhost/badhan/contruct_us/contract.html">Contact Us</a></li>
		...
		$query="select ID,month,name,father_name,mother_name,village,po,phone,gender,weight,blood_group,Date,checkbox from information_table where blood_group='B-' and month>='3'";
